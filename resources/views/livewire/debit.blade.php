                         ...
                         <table  class="w-full divide-y divide-gray-200 table-auto">
                             <thead class="bg-indigo-500 text-white">
                                 <tr class="text-left text-xs font-bold  uppercase">
                                     ...
                                     <th class="px-4 py-2">association_id</th>
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td class="border px-4 py-2">{{ $debit->type }}</td>
                                     <td class="border px-4 py-2">{{ $debit->amount}}</td>
                                     <td class="border px-4 py-2">{{ $debit->description }}</td>
                                     <td class="border px-4 py-2">{{ $debit->associate_id}}</td>
                                     <td class="border px-4 py-2">{{ $debit->association_id }}</td>
                                     <td class="border px-4 py-2">
                                     <button wire:click="edit({{ $debit }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</button>
                                     <button wire:click="delete({{ $debit }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                                     </td>
                                 </tr>
                                 @endforeach

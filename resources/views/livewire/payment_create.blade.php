        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="">
                <div class="mb-4">
                    ...
                    <input type="text" wire:model="amount" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Nombre de la Asociacion">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">assistence:</label>
                    <select wire:model="assistence_id" class="form-select shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" aria-label="Default select example">
                        <option selected >slecione una opcion</option>
                        @foreach ($assistences as $assistence)
                          <option value="{{$assistence->id}}">{{$assistence->id}}</option>
                        @endforeach

                    </select>
                    @error('assistence_id') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
          </div>
        </div>

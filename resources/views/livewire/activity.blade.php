                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $activity->association_id }}</td>
                            <td class="border px-4 py-2">
                            <button wire:click="edit({{ $activity }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</button>
                            <button wire:click="delete({{ $activity }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                            </td>
                        </tr>
                        @endforeach
